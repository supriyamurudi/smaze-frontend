        ...
        <div key={i} className="rounded-2xl border bg-white p-6 shadow-sm">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center">
            <div className="flex gap-5">
              <div className="h-28 w-28 bg-slate-200 rounded-xl animate-pulse"></div>
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-1 gap-5">
          <img
            ...
            alt={offer.title}
            className="h-28 w-28 rounded-xl object-cover border border-slate-200 transition-transform group-hover:scale-105"
            onError={(e) => {
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2">
              ...
              <span className="inline-flex items-center gap-1 rounded-full bg-gradient-to-r from-rose-100 to-orange-100 px-3 py-1 text-xs font-bold text-rose-700">
                {offer.discount}% OFF
              </span>
        ...
        {/* Right Section - Buttons (Vertical) */}
        <div className="flex flex-row gap-2 lg:flex-col lg:gap-2">
          <Link
            to={`/shop/offers/${offer.id}`}
            className="inline-flex items-center justify-center gap-1.5 rounded-xl bg-gradient-to-r from-violet-600 to-purple-600 px-4 py-2 text-sm font-medium text-white transition hover:scale-105 hover:shadow-lg"
          >
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-1.5 rounded-xl border border-violet-200 bg-white px-4 py-2 text-sm font-medium text-violet-600 transition hover:bg-violet-50 hover:scale-105"
          >
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 rounded-xl border border-red-200 bg-white px-4 py-2 text-sm font-medium text-red-500 transition hover:bg-red-50 hover:scale-105"
          >
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div>
            <h1 className="text-4xl font-black text-slate-900">My Offers</h1>
        ...
        >
          ...
          <input
            ...
            className="w-full rounded-xl border-0 bg-white py-3.5 pl-12 pr-4 text-slate-800 shadow-md outline-none ring-1 ring-slate-200 transition placeholder:text-slate-400 focus:ring-2 focus:ring-violet-500"
          />
        </motion.div>
        ...
        >
          {filteredOffers.length === 0 ? (
            <div className="flex flex-col items-center rounded-2xl border-2 border-dashed border-slate-300 bg-white/50 py-20 text-center">
              ...
              {!search && (
                <Link
                  to="/shop/add-offer"
                  className="mt-4 inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-violet-600 to-purple-600 px-6 py-2.5 font-semibold text-white transition hover:scale-105 hover:shadow-lg"
                >
