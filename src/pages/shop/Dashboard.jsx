...
const QuickAction = ({ title, path, icon: Icon }) => (
  <motion.div whileHover={{ y: -2 }} whileTap={{ scale: 0.97 }}>
    <Link
      to={path}
      className="flex items-center gap-3 sm:gap-4 rounded-xl bg-white border border-slate-200 p-4 shadow-sm transition-all hover:shadow-md hover:border-violet-300"
    >
        ...
        >
          <div className="rounded-2xl bg-white border border-slate-200 p-4 sm:p-5 shadow-sm">
            <div className="flex items-center gap-3">
              <div className="rounded-lg bg-violet-50 p-2.5 text-violet-600 flex-shrink-0">
          ...
          <div className="rounded-2xl bg-white border border-slate-200 p-4 sm:p-5 shadow-sm">
            <div className="flex items-center gap-3">
              <div className="rounded-lg bg-slate-100 p-2.5 text-slate-600 flex-shrink-0">
