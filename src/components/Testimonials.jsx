...
const testimonials = [
  {
    ...
    review:
      "Smaze helped me discover amazing restaurant deals in Belagavi. I saved a lot on my weekend outings!",
    rating: 5,
  },
  {
    id: 2,
    ...
    review:
      "Listing my boutique on Smaze brought many new customers. It's an easy and effective platform for local businesses.",
    rating: 5,
  },
  {
    id: 3,
    ...
    review:
      "The interface is simple, and I love getting notified about nearby offers. Highly recommended!",
    rating: 5,
  },
];
            ...
            >
              ...
              <div className="flex items-center gap-3 sm:gap-4 border-t border-slate-100 pt-4 sm:pt-5 md:pt-6">
                <img
                  ...
                  onError={(e) => {
                    e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(item.name)}&background=7c3aed&color=fff&size=128`;
                  }}
                />
